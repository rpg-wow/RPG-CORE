...
void Eluna::LoadScriptPaths()
{
    ...
    lua_folderpath = sConfig.GetStringDefault("Eluna.ScriptPath", "lua_scripts");
...
void Eluna::OpenLua()
{
    enabled = sConfig.GetBoolDefault("Eluna.Enabled", true);
    if (!IsEnabled())
    {
...
bool Eluna::ExecuteCall(int params, int res)
{
    ...
    bool usetrace = sConfig.GetBoolDefault("Eluna.TraceBack", false);
    if (usetrace)
    {
